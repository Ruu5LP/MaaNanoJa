...
//   - 'full'  : 記録タブで、自分の入力フォームの“上に添える”観戦画面。スコアボード＋これまでの局ログ＋
//               今打っている1局をフル表示する（フォームは消さない。下に残す）。
//
// どちらも「中身のある実況」のときだけ出す（呼び出し側で lib/live.ts#hasLiveContent で判定）。
// 空の準備中や壊れた対局で相手の入力画面を占領しないため。
//
// 段階（phase）も2つ:
